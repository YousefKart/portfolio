    ...
    <AnimatePresence>
      {open && data && (
        <>
          ...
          {/* Modal panel — expands from center via clip-path */}
          <motion.div
            key="modal-panel"
          ...
          >
            <motion.div
              ref={scrollRef}
              className="
                pointer-events-auto relative w-full overflow-y-auto
                bg-card text-foreground
                sm:rounded-2xl sm:max-w-3xl sm:max-h-[90vh]
            ...
            >
              ...
              {data.images?.length ? (
                ...
                <div className="h-48 sm:h-64 bg-muted/30 border-b border-border/40" />
              )}
