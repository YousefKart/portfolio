...
const projects = [
  ...
  },
  {
    ...
    title: "Flag Frenzy",
    links: [
      { icon: <FaLink />, url: 'https://www.roblox.com/games/15222475262/NEW-GUNS-FLAG-FRENZY-RED-VS-BLUE' },
    ],
    images: [
  ...
  },
  {
    ...
    title: "Tourify",
    links: [
      { icon: <FaGithub />, url: 'https://github.com/BorhanSaflo/tourify-android-app' },
    ],
    images: [
  ...
  },
  {
    ...
    links: [
      ...
      { icon: <FaYoutube />, url: 'https://www.youtube.com/watch?v=1XG5x_ulwCk' },
    ],
    images: [
